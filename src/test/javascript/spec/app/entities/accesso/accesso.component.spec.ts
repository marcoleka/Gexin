...
import { AccessoComponent } from 'app/entities/accesso/accesso.component';
import { AccessoService } from 'app/entities/accesso/accesso.service';
import { Accesso } from 'app/shared/model/accesso.model';

describe('Component Tests', () => {
    describe('Accesso Management Component', () => {
        let comp: AccessoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AccessoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.accessos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
