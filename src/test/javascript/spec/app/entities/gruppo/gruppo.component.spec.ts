...
import { GruppoComponent } from 'app/entities/gruppo/gruppo.component';
import { GruppoService } from 'app/entities/gruppo/gruppo.service';
import { Gruppo } from 'app/shared/model/gruppo.model';

describe('Component Tests', () => {
    describe('Gruppo Management Component', () => {
        let comp: GruppoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GruppoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.gruppos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
