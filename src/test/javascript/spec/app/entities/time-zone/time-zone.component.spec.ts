...
import { TimeZoneComponent } from 'app/entities/time-zone/time-zone.component';
...
describe('Component Tests', () => {
    describe('TimeZone Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TimeZoneComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.timeZones[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
