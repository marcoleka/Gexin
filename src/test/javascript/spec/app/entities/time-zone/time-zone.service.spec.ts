...
describe('Service Tests', () => {
    describe('TimeZone Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TimeZoneService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/time-zones';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a TimeZone', () => {
                service.create(new TimeZone(null)).subscribe(received => {
            ...
            it('should update a TimeZone', () => {
                service.update(new TimeZone(123)).subscribe(received => {
