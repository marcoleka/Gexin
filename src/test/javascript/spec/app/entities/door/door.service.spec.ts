    ...
    describe('Door Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/doors';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Door', () => {
                service.create(new Door(null)).subscribe(received => {
            ...
            it('should update a Door', () => {
                service.update(new Door(123)).subscribe(received => {
